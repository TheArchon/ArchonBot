...
@app.on_callback_query(
    filters.regex("cancel_dl") & ~app.bl_users
)
@lang.language()
...
@app.on_callback_query(
    filters.regex("controls") & ~app.bl_users
)
@lang.language()
@can_manage_vc
...
@app.on_callback_query(
    filters.regex("settings") & ~app.bl_users
)
@lang.language()
@admin_check
...
@app.on_callback_query(
    filters.regex("^autoplay_panel")
    & ~app.bl_users
)
@lang.language()
async def _autoplay_panel(
    _,
    ...
    if action == "info":
        ...
        return await query.edit_message_text(
            ...
            reply_markup=buttons.autoplay_info_markup(
                query.lang
            ),
        )
